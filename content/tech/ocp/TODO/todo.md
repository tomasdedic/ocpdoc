...
tags:
  - "OCP"
---
### 1. IPI instalace s UDR

**dokumenty:**
+ [/instalaceAzure/]({{< relref "../instalaceAzure/index.md" >}})
...
### 2. Integrace AAD  a LDAP group sync 
...
### 3. Ingres více routerů, route sharding
...
### 5. Network policy/netnamespace isolation
